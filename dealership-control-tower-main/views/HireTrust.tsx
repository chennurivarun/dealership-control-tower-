      ...
      <div className="max-w-3xl mx-auto glass p-3 rounded-[32px] shadow-2xl ring-1 ring-black/5 dark:ring-white/10 flex items-center gap-4 transition-all">
        ...
        <button
          onClick={() => {
            ...
            else alert("Employee not found in centralized trust database.");
          }}
          className="bg-blue-600 text-white px-10 py-4.5 rounded-[24px] font-black uppercase tracking-widest text-xs shadow-xl shadow-blue-900/40 hover:scale-105 active:scale-95 transition-all"
        >
          Lookup Trust
        </button>
      </div>
