...
const Spares: React.FC = () => {
   ...
   const filteredSpares = MOCK_SPARES.filter(p =>
                  ...
                  <div className="flex gap-4 w-full md:w-auto">
                     <div className="relative group flex-1">
                        ...
                        <input
                           ...
                           className="pl-12 pr-6 py-4 glass rounded-[24px] text-[10px] font-black outline-none uppercase tracking-widest border-none w-full md:w-64 focus:md:w-80 transition-all focus:bg-slate-100 dark:focus:bg-charcoal-900 shadow-sm transition-colors"
                           value={searchTerm}
                           ...
                           <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 hidden group-hover:block z-40">
                              <div className="glass bg-white dark:bg-charcoal-950 p-5 rounded-[24px] shadow-[0_30px_60px_rgba(0,0,0,0.3)] w-48 ring-1 ring-black/5 dark:ring-white/10 animate-in fade-in zoom-in-95">
                                 ...
                                 <p className="text-xs font-black text-slate-900 dark:text-white leading-tight">
                                    {MOCK_SPARES[i % MOCK_SPARES.length].name}
                                 </p>
                                 <div className="mt-4 flex items-center justify-between border-t border-black/5 dark:border-white/5 pt-3">
                                    ...
                                    <span className="text-xs font-black text-blue-500">{MOCK_SPARES[i % MOCK_SPARES.length].onHand}</span>
                                 </div>
                              </div>
                           </div>
                        </div>
